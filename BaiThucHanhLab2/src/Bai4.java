...
//  Viết chương trình nhập vào một số nguyên từ 
//  1 - 12 từ bàn phím và hiển thị ra tháng tương ứng với số đó
...
public class Bai4 {
    public static void main(String[] args) {
        ...
        switch(m){
            ...
            default: System.out.print("Khong co thang nao la thang " + m);
        }
